# Generated by Django 3.2.6 on 2023-03-08 05:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(blank=True, null=True, related_name='jobs', to='Core.Category')),
                ...
                ('employment_status', models.ManyToManyField(blank=True, null=True, related_name='jobs', to='Core.EmploymentStatus')),
                ...
                ('skills', models.ManyToManyField(blank=True, null=True, related_name='jobs', to='Core.Skill')),
